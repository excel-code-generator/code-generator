...
public class DdlSqliteGeneratorImpl extends BaseGenerator {
	...
	protected void onGeneration() throws CodeGenException {
		...
		// 转换为可写入的Model（单个文件）
		ITranslator<List<DdlModel>> translator = GenFactory.createByName(SupportGen.ddl_sqlite_translator);
